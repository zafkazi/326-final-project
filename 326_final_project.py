...
def create_inflation_table():
    ...
    inflation_data = {
        ...
        'Inflation Rate (%)': [3.73, 2.62, 2.35, 1.43, 1.55, 2.19, 2.4, 2.21, 1.93, 3.48, 8.27]
    }
...
def show_result(result):
    if result is not None:
        tk.messagebox.showinfo("Result", str(result))
    else:
        tk.messagebox.showerror("Error", "Operation failed.")
